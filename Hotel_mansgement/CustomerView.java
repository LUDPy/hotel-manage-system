...
public class CustomerView {
    ...
    public static void addCustomer() {
        Customer.arrCustomer[Customer.cout] = new Customer();
        if (Customer.cout >= Customer.arrCustomer.length) {
        ...
        Customer.arrCustomer[Customer.cout].setRoomId(roomId);
        System.out.println("请输入顾客姓名:");
        String name = sc.next();
        Customer.arrCustomer[Customer.cout].setName(name);
        System.out.println("请输入顾客年龄:");
        int age = sc.nextInt();
        Customer.arrCustomer[Customer.cout].setAge(age);
        System.out.println("请输入性别(男/女):");
        String gender = sc.next();
        Customer.arrCustomer[Customer.cout].setGender(gender);
        System.out.println("请输入顾客身份证号码:");
        String idNumber = sc.next();
        Customer.arrCustomer[Customer.cout].setIdNumber(idNumber);
        Customer.cout++;
    ...
    public static void deleteCustomer() {
        ...
        if (num == -1) {
            ...
            System.arraycopy(Customer.arrCustomer, num + 1, Customer.arrCustomer, num, Customer.cout - num);
            Customer.arrCustomer[Customer.cout] = null;
            Customer.cout--;
